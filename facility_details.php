        ...
        <div class="row">
            ...
            <div class="col-12 my-5 mb-4 px-4">
                ...
                <div style="font-size: 14px;">
                    ...
                    <a href="facility.php" class="text-success text-decoration-none">Facilities</a>
                    <span class="text-success"> > </span>
                ...
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        if (!$title_r['shutdown']) {
                            ...
                            $checkin_js = json_encode($checkin);
                            $checkout_js = json_encode($checkout);
                            echo <<<book
                            <button onclick='checkLoginToBook2($login_js,$room_id_js,$checkin_js,$checkout_js)' class='btn btn-sm w-100 btn-success rounded shadow-none py-2 px-4 mb-1' data-bs-toggle='modal'>Book Now </button>
                            book;
                        }
                        ?>
        ...
        $(document).ready(function() {
            ...
            function load_rating_data() {
                $.ajax({
                    ...
                    method: "POST",
                    data: {
                        action: 'load_data', room_id: <?php echo json_encode($room_data['room_id']); ?>
                    },
                    dataType: "JSON",
                    success: function(data) {
