...
<head>
    ...
    <title>HM Hotel | Checked-out Bookings</title>
</head>
...
<div class="container-fluid" id="main-content">
                                        ...
                                        echo <<< HTML
                                                        ...
                                                        <div class="collapse navbar-collapse justify-content-ceter" id="navbarSupportedContent">
                                                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link text-success AMactive" href="checkout_booking.php"><b>Checked-out</b></a>
                                                                </li>
                                        ...
                                        echo <<< HTML
                                                    ...
                                                    <div class="collapse navbar-collapse justify-content-ceter" id="navbarSupportedContent">
                                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link text-success fw-bold AMactive" href="checkout_booking.php">Checked-out</a>
                                                            </li>
    ...
    <script src="scripts/checkout_bookings.js"></script>
</body>
