...
<head>
    ...
    <title>HM Hotel | Cancelled Bookings</title>
</head>
...
<body>
                                        ...
                                        echo <<< HTML
                                                        ...
                                                        <div class="collapse navbar-collapse justify-content-ceter" id="navbarSupportedContent">
                                                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link text-success Aactive" href="cancelled.php"><b>Cancelled</b></a>
                                                                </li>
                                                            </ul>
                                        ...
                                        echo <<< HTML
                                                    ...
                                                    <div class="collapse navbar-collapse justify-content-ceter" id="navbarSupportedContent">
                                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link  fw-bold Factive" href="checkin_booking.php">Checked-in</a>
                                                            </li>
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link text-success Aactive" href="cancelled.php">Cancelled</a>
                                                            </li>
                                                        </ul>
    ...
    <script src="scripts/cancelled_bookings.js"></script>
