...
if ($date == $lastday) {
    ...
    $nxt_month = date("Y-m-d", strtotime($date . " +15 days"));
} else {
    $nxt_month = date("Y-m-t", strtotime($date));
}
...
<body>
        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="d-flex justify-content-between">
                    <a href="CreateNew_bookings.php" class="shadow-none mb-3 w-100 btn btn-success fw-bold text-center me-2">Bookings for Rooms</a>
                    <button disabled class="shadow-none mb-3 w-100 btn btn-outline-success fw-bold text-center ">Bookings for Facility</button>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="text-secondary text-center mb-1">
                        <h3 class="text-dark">Booking for Facility</h3>
                        <h6 class="">Available Facility</h6>
                    </div>
    ...
    <script>
        ...
        function fetch_rooms() {
            ...
            xhr.open("GET", "ajax/manualbook.php?fetch_facility&chk_avail=" + chk_avail + "&guests=" + guests + "&feature_list=" + feature_list, true);
